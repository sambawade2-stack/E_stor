<x-admin-layout title="Marques">
    ...
    <div class="grid gap-6 lg:grid-cols-3">
        ...
        <section class="h-fit rounded-2xl border border-gray-100 bg-white p-6">
            <h2 class="mb-4 text-lg font-bold">Nouvelle marque</h2>
                            ...
                            <tr class="transition hover:bg-gray-50/70" x-data="{ editing: false }">
                                <td class="px-6 py-3" colspan="4" x-show="editing" x-cloak>
                                    <form action="{{ route('admin.brands.update', $brand) }}" method="POST" enctype="multipart/form-data"
                                        ...
                                        <input type="file" name="logo" accept="image/*" class="text-sm text-gray-500">
                                        ...
                                        <button type="button" @click="editing = false" class="text-sm text-gray-500 hover:text-gray-600">Annuler</button>
                                    </form>
                                </td>
